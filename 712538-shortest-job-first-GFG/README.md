...
Your Task:You don't need to read input or print anything. Your task is to complete the function solve() which takes bt[]&nbsp;as input parameter&nbsp;and returns the average waiting time&nbsp;of all the processes.
Expected Time Complexity: O(nlog(n))Expected Auxiliary Space: O(1)
